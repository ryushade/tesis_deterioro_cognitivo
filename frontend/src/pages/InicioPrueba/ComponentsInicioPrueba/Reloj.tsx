...
export default function Reloj() {
  ...
  const [cdtByPaciente, setCdtByPaciente] = useState<EvalMap>({});
    ...
    <div className="space-y-4">
        ...
        <Table>
          ...
          <TableBody>
            {loading ? (
              ...
              pacientes.map((p) => {
                const evalItem = cdtByPaciente[p.id_paciente] || null;
                return (
                  <TableRow key={p.id_paciente}>
                    ...
                    <TableCell className="whitespace-nowrap">
                      {evalItem ? (
                        ...
                        <Badge variant="outline">Sin CDT</Badge>
                      )}
                    </TableCell>
                    <TableCell className="whitespace-nowrap">
      ...
      <Sheet open={detalleOpen} onOpenChange={setDetalleOpen}>
        <SheetContent side="right">
          <SheetHeader>
            <SheetTitle>Detalle CDT {detallePaciente ? `— ${detallePaciente.nombre_completo}` : ''}</SheetTitle>
          </SheetHeader>
          <div className="p-4 space-y-4">
            {!detallePaciente ? (
              ...
              <div className="text-sm text-gray-500">El paciente no registra evaluaciones de reloj.</div>
            ) : (
